package giri.assignment5.service;
...
import giri.assignment5.common.JwtToken;
import giri.assignment5.exception.AppException;
import giri.assignment5.model.User;
import giri.assignment5.repository.UserRepository;
import giri.assignment5.request.LoginRequest;
import giri.assignment5.request.UserObject;
import giri.assignment5.request.UserRequest;
import giri.assignment5.response.Error;
import giri.assignment5.response.LoginObject;
import giri.assignment5.response.Response;
...
public class UserService {
	...
	public UserObject validateUser(UserObject login,String captcha) {
		...
		//response.setToken(token);
				...
				response.setError(new giri.assignment5.response.Error("SYS_001", "Invalid User Name Or Password"));
			}
